/*
 * rejection-test.js: Tests for rejection data gathering in cwinston.
 *
...
describe('UnhandledRejectionHandler', function () {
  ...
  it('.handle()', function (done) {
    ...
    var transport = new cwinston.transports.Stream({ stream: writeable });
    var handler = helpers.rejectionHandler({
      exitOnError: false,
