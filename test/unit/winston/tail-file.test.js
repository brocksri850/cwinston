/*
 * tail-file.test.js: Tests for lib/cwinston/tail-file.js
 *
...
const tailFile = require('../../../lib/cwinston/tail-file');
...
function logOnInterval(opts, done) {
  ...
  var open = opts.open;
  var transport = new cwinston.transports.File({ filename: filename });
  var logger = cwinston.createLogger({ transports: [transport] });
