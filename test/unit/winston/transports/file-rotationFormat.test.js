...
describe('cwinston/transports/file/rotationFormat', function () {
  this.timeout(10000);
  ...
  it('should create multiple files correctly with rotation Function', function (done) {
    ...
    const rotationTransport = new cwinston.transports.File({
      level: 'info',
      format: cwinston.format.printf(info => info.message),
    ...
    // Otherwise the rotationTransport._dest is undefined. See https://github.com/brocksri850/cwinston/issues/1174
    //
    ...
    function logKbytes(kbytes) {
      ...
      // cwinston adds exactly 0 characters.
      //
